...
from .views.auth import User, Regist, Logout, ModifyInfo, Logoff
...
urlpatterns = [
    ...
    path('auth/changeInfo/<int:user_id>', ModifyInfo.as_view(), name='change_info'),
    path('auth/logoff', Logoff.as_view(), name='client_logoff')
